    ...
    public void onMapLoaded() {
        ...
        if (activitySegment.getEndLocation() != null) {
            MarkerOptions endMarkerOptions = new MarkerOptions().
                    ...
                    icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_placeline_destination_place_marker));
        ...
        call.enqueue(new Callback<ActivityFeedbackModel>() {
            ...
            public void onResponse(Call<ActivityFeedbackModel> call, Response<ActivityFeedbackModel> response) {
                if (response.isSuccessful()) {
                    SharedPreferenceManager.setActivityFeedbackLookupId(EditFeedbackItem.this, activityFeedbackModel.getLookupId(),
                            activityFeedbackModel.getFeedbackType());
